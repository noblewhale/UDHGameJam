namespace Noble.DungeonCrawler
{
    ...
    public class TargetAoeShapeBehaviour : TargetableBehaviour
    {
		...
		override protected List<Tile> GetThreatenedTiles()
		{
			...
			Vector2 rayStart = (Vector2)identityCreature.transform.position + Map.instance.tileDimensions / 2;
			...
			if (threatenedTiles.Count >= 1)
			{
				...
				{
					Vector2Int pos = threatenedTiles[0].tilePosition + relativeLocation;
