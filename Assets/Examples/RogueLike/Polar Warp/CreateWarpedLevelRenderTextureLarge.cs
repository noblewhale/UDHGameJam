namespace Noble.DungeonCrawler
{
    ...
    public class CreateWarpedLevelRenderTextureLarge : MonoBehaviour
    {
        public Map map;
        ...
        void Start()
        {
            ...
            float renderedWidth = 37;
            float renderedHeight = 17;
            ...
            int renderTextureHeight = (int)(renderedHeight * 128);// (int)(renderTextureWidth / 4.5f);
